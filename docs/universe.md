...
- **Moebius** — silence, flat color fields, vast negative space, and proper nouns dropped without
  ...
  in `assets/image-assets.json` asks for "late-1970s French science-fiction comic mood" — it did so
...
- **Creatures** — the wolf pack: pups, skulkers, a denmother who licks her pack's wounds closed.
  Fur, mud, teeth.
- **People** — a ranger's lean-to at the treeline; someone waved you in and won't follow.
...
afternoon sky, everything oxidizing toward red-brown — and just slightly _off_. The riverbed you
follow is dry. A herder's bell rings with no herd in sight. The horizon has one silhouette too
many — a rider, too far to hail, gone when you look again. Moebius creeps in at the edges while the
foreground stays homey.
...
> **Image prompt** — A luminous fungal forest at dusk, enormous glowing mushrooms among drowned
> trees, spores drifting in shafts of teal and gold light, a slow glowing stream winding through
> dense bioluminescent undergrowth, a small masked pilgrim figure walking a raised root path.
...
> silhouette on the far horizon. Flat muted color fields, precise elegant contours, surreal
...
- **glow-masked-pilgrims** — the pilgrims' masks are plain white ovals, the road a mossy root
  bridge. They walk downstream, as written.
- **white-first-water** — the terraced pools, and the rider is _in the painting_, one tiny
  silhouette on the horizon. The thread landed.
- **white-source-keeper** — Uvalu at architecture scale: pale ribbed shell, ribbon-like sails, one
  gold glow low at the spring. Wound and ward in one, and the rider again at the edge.
