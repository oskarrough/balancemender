...
export class AudioPlayer extends Node {
	...
	sounds: SoundLibrary = {
		...
		combat: {
			air_hit: 'air-in-a-hit-2161.ogg',
			arrow: 'arrow-shot-through-air-2771.ogg',
			ball_tap: 'game-ball-tap-2073.ogg',
			body_punch: 'body-punch-quick-hit-2153.ogg',
			fast_blow: 'fast-blow-2144.ogg',
			fast_punch: 'martial-arts-fast-punch-2047.ogg',
			punch_through_air: 'punch-through-air-2141.mp3',
			quick_punch: 'soft-quick-punch-2151.ogg',
			strong_punch: 'strong-punches-to-the-body-2198.ogg',
			strong_punch2: 'impact-of-a-strong-punch-2155.mp3',
			sword_hit: 'strong-punches-to-the-body-2198.ogg',
		},
		ui: {
			// UI sounds go here
		},
