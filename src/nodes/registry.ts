import {Heal, FlashHeal, GreaterHeal, Renew, PowerWordShield, Smite, Mend} from './spells'
...
export const playerAbilities = {Heal, FlashHeal, GreaterHeal, Renew, PowerWordShield, Smite} as const
